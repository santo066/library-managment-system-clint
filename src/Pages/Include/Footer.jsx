...
export default function Footer() {
    return (
        <div>
            <footer className="footer footer-center p-10  bg-[#e1cec4] mt-14 text-primary-content">
                <aside>
                    <img src={logo} className='w-16' alt="" />
                    <p className="font-bold text-black">
                        WONTED <br />Providing reliable tech since 1992
                    </p>
                    <p className='text-black'>Copyright © 2024 - All right reserved</p>
                </aside>
                <nav>
                    <div className="grid md:grid-flow-col  gap-4 text-black list-none">
                        ...
                        <li><Link to={'/borrowedbook'}><a> Borrowed Books</a></Link></li>
